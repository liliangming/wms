 ...
 * @version 2018-12-14
 */
@Table(name="xhs_supplier_contact", alias="a", columns={
		@Column(name="id", attrName="id", label="主键", isPK=true),
		@Column(name="supplier_id", attrName="supplierId.id", label="供应商id"),
		@Column(name="name", attrName="name", label="联系人姓名", queryType=QueryType.LIKE),
...
public class XhsSupplierContact extends DataEntity<XhsSupplierContact> {
	...
	public XhsSupplierContact() {
		this(null);
	}


	public XhsSupplierContact(XhsSupplierInfo supplierId){
	...
	@Length(min=0, max=100, message="联系人姓名长度不能超过 100 个字符")
